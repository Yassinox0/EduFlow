...
$migrationDirectory = $backendDirectory . '/storage/upstream-migrations';
...
try {
    $pdo = new PDO(
        ...
        [
            ...
            (defined('Pdo\\Mysql::ATTR_MULTI_STATEMENTS') ? constant('Pdo\\Mysql::ATTR_MULTI_STATEMENTS') : constant('PDO::MYSQL_ATTR_MULTI_STATEMENTS')) => true,
        ]
    );
