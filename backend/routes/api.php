...
Router::add('GET', '/api/personnel/next-number', [new PersonnelController(), 'nextNumber'], [AuthMiddleware::class]);
Router::add('GET', '/api/personnel', [new PersonnelController(), 'index'], [AuthMiddleware::class]);
Router::add('POST', '/api/personnel', [new PersonnelController(), 'store'], [AuthMiddleware::class, new RoleMiddleware(['admin','super_admin'])]);
Router::add('GET', '/api/personnel/{id}', [new PersonnelController(), 'show'], [AuthMiddleware::class]);
Router::add('PUT', '/api/personnel/{id}', [new PersonnelController(), 'update'], [AuthMiddleware::class, new RoleMiddleware(['admin','super_admin'])]);
Router::add('PATCH', '/api/personnel/{id}/status', [new PersonnelController(), 'status'], [AuthMiddleware::class, new RoleMiddleware(['admin','super_admin'])]);
